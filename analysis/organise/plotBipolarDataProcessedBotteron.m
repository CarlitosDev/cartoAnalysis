...
for currentIdx = 1:numSignals
    ...
    normInputPSD = scaleFrom0To1(inputPSD);
...
%     plot(inputPSDOmega, inputPSD, 'LineWidth', 2);
    plot(inputPSDOmega, normInputPSD, 'LineWidth', 2);
    
    
    % Overlay Botteron's spectrum
    [powSpectDens, psdOmega] = ...
        getPowerSpectralDensityBotteron(currentSignal, selDataIn.fs, ...
        'windowType', 'rectangular'         , ...
        'windowSize', length(currentSignal) , ...
...
%         'LineWidth', 1.5, 'Color', [0 1 0]);
    ...
    normBottPSD = scaleFrom0To1(powSpectDens);
    plot(psdOmega, normBottPSD, ...
        'LineWidth', 1.5, 'Color', [0 1 0]);
