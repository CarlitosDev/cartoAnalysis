...
listOfPoints = [113,107,8,137,108,115,383,124,5,308];   % sup
%listOfPoints = [365,261,363,362,249,358,234,359,39,165];% mid
%listOfPoints = [287,272,62,264,99,286,40,26,88,33];     % inf
...
mainFolder = '/Users/JL/Google Drive/Proyectos/TesisCarlos/codigoCarlos';
...
for idxPoint = 1:numPoints
    ...
    for idx=1:numOutputSignalsICA
        ...
        outSignalName = sprintf('ICA #%d k = %3.2f\n', idx, eKurtValues(idx));
